package com.hris.metadata.domain.term.controller;

import com.hris.metadata.domain.term.dto.request.SchemaMappingRequest;
import com.hris.metadata.domain.term.dto.request.SynonymRequest;
import com.hris.metadata.domain.term.dto.request.TermRequest;
import com.hris.metadata.domain.term.dto.response.ImportResult;
import com.hris.metadata.domain.term.dto.response.SchemaMappingResponse;
import com.hris.metadata.domain.term.dto.response.SynonymResponse;
import com.hris.metadata.domain.term.dto.response.TermResponse;
import com.hris.metadata.domain.term.service.DictionaryImportService;
import com.hris.metadata.domain.term.service.TermAdminService;
